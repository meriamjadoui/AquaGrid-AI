    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: 'var(--color-text-muted)' }}>Real-time monitoring — Borehole Site #1, Tunis</p>
        </div>
        <button
          onClick={togglePump}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          {[
            ...
            <div key={label}>
              ...
              <p
                className="text-base font-semibold data-value mt-1"
                style={{ color: ok ? '#10b981' : 'var(--color-text)' }}
              >
                {value}
              </p>
            </div>
